...
from prediction.attack.backbone import DTPAttacker
from blackbox_utils import *
from dataset_config import datasets, models
...
def attack(model_name, dataset_name, overwrite=0, mode="single_frame", augment=False, smooth=0, blackbox=False):
    ...
    attacker = DTPAttacker(api.obs_length, api.pred_length, attack_length, api, physical_bounds=physical_bounds)
